...
| [ft_power](srcs/math/ft_power.c) | Renvoie un entier à la puissance edemandée. |
...
| nom | man |
| ---- | ---- |
| [ft_addncharbefore](srcs/memory/ft_addncharbefore.c) | Ajoute un nombre de caractères donné au debut chaîne de caractères. |
...
| nom | man |
| ---- | ---- |
| [ft_char_index](srcs/string/ft_char_index.c) | Cherche un caractère dans une chaîne de caractère et retourne l'index de sa première occurence. |
| [ft_strcapitalize](srcs/string/ft_strcapitalize.c) | Passe la chaîne de caractère en majuscule. |
...
| [ft_strlenwcs](srcs/string/ft_strlenwcs.c) | Retourne la longeur de la chaîne de wildchar passée en paramètre. |
| [ft_strlowerize](srcs/string/ft_strlowerize.c) | Passe la chaîne de caractère en minuscule. |
...
| [ft_strrev](srcs/string/ft_strrev.c) | Inverse une chaîne de caractères. |
| [ft_strrstr](srcs/string/ft_strrstr.c) | Recherche une chaîne de caractères dans une autre et retourne l'adresse de sa dernière occurence. |
| [ft_strsplit](srcs/string/ft_split.c) | Alloue et retourne un tableau de chaînes de caractères “fraiches” (toutes terminées par un `\0`) résultant de la découpe de s selon le caractère c. Si l’allocation échoue, la fonction retourne NULL. |
| [ft_strstr](srcs/string/ft_strstr.c) | Recherche une chaîne de caractères dans une autre et retourne l'adresse de sa première occurence. |
...
| [ft_strupperize](srcs/string/ft_strupperize.c) | Passe la chaîne de caractère en majuscule. |
| [ft_wcslen](srcs/string/ft_wcslen.c) | Renvoie la longueur d'un wildchar. |
